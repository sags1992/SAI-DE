<html>
    ...
    <body onload="document.getElementById('nombre').focus()">
        ...
        <div class="container">
            ...
            <div id="contenedor">
                <form action="evento_guardar.php" method="post" name="formulario">


                    <div class="label_div">Descripcion: </div>
                    <input type="text"  class="campo" name="evento" required="" size="80" placeholder="Ej. Reunion de padres Kids 4..." >
                    <br>
                    <br>
