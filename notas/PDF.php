...
class PDF extends FPDF {
    ...
    function cabeceraHorizontal($cabecera) {
        ...
        foreach ($cabecera as $fila) {
            $this->RoundedRect($ejeX, 30, 40, 7, 2, 'FD');
    ...
    function datosHorizontal($datos) {
        ...
        foreach ($datos as $fila) {
            ...
            $this->CellFitSpace(40, 7, utf8_decode($fila['id_nivel']), 0, 0, 'L');
            $this->CellFitSpace(40, 7, utf8_decode($fila['nivel']), 'LR', 0, 'L');
            $this->CellFitSpace(40, 7, utf8_decode($fila['borrado']), 0, 0, 'L');
